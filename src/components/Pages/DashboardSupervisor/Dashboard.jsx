...
import GraficoTotalOperacoesUsuarios from './Grafico Total Operações Usuários/Grafico';
import GraficoTotalOperacoesComissoes from './Grafico Total Operacoes Comissoes/Grafico';
import GraficoTotalOperacoesSetor from './Grafico Total Operações Setor/Grafico';
import NavResumo from './Nav Resumo/Grafico';
import GraficoTotalOperacoesCidades from './Grafico Total Operacoes Cidades/Grafico';
import GraficoPlanosEValores from './Grafico Planos e Valores/Grafico';
import Tabela from './Tabela Clientes/Tabela';
            ...
            <Tabs className={styles.tabIndex} selectedIndex={tabIndex} onSelect={(index) => setTabIndex(index)}>
              ...
              <TabPanel>
                <div className={styles.container}>
                      ...
                      <GraficoTotalOperacoesUsuarios filter={filter} />
                      <GraficoPlanosEValores filter={filter} />
                </div>
              </TabPanel>

              <TabPanel>
                <div className={styles.container}>
                    <GraficoTotalOperacoesSetor filter={filter} />
